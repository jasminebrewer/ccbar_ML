...
//_________________________________________________________________________________________________
int initialize_pythia( string paramfile_name, Pythia& pythia, struct trackCuts& track_cuts, bool D0decay=false);
...
void depth_first(Event& event, int current_particle, vector<int>& was_visited);
